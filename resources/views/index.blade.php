    ...
    >
        <div class="gap-y-4 flex flex-col">
            <div class="flex items-center justify-between">
                ...
                <kbd class="bg-neutral-100 text-sm px-2 py-px rounded-lg">⌘ + Enter</kbd>
            </div>

            <div id="editor" class="flex-1 rounded-lg overflow-hidden"></div>
        </div>
        ...
        <div class="gap-y-4 flex flex-col">
            ...
            <div class="relative flex-1 border border-neutral-300 rounded-lg" id="output-wrapper">
